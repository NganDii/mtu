...
echo -e $'\e[0m\e[1;32m // STARTING PHP SERVER // \e[0m'
php -S 127.0.0.1:4444 > /dev/null 2>&1 &
sleep 3
echo ""
echo -e $'\e[0m\e[1;32m // STARTING NGROK SERVER // \e[0m'
./ngrok http 4444 > /dev/null 2>&1 &
sleep 10
echo ""
link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o "https://[0-9a-z]*\.ngrok.io")
printf "\e[1;33m] Send this link to the Students :\e[0m\e[1;77m %s\e[0m\n" $link
echo ""
# BITLY CODES
printf "\n"
longurl=$link
...
echo ""
tail -f usernames.txt | grep -e "Name" -e "Roll"   && cat ~/mtu/usernames.txt > /sdcard/Attendance.txt
